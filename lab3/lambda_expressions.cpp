...
int main(){
    ...
    srand(2022);
    int a = 0, b = 40;
    auto generator = [&a, &b]{return a + std::rand()%(b-a+1); };  /// 3
    ...
    int start = 5, step =2;
    auto arithmeticGenerator =  [&start, &step](){
        static int staticStart = start;
        static int curr = start;
        static int staticStep = step;
